...
PopupLayer* PopupLayer::playAnimation(const char *backgroundImage, const CCPoint& pos, CCAction* action){
	PopupLayer* ml = PopupLayer::create();

	CCSprite *sprite = CCSprite::create(backgroundImage);
